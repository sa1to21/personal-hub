...
Микросервисное веб-приложение для управления проектами (kanban-доски) с аутентификацией. Вся инфраструктурная часть (Docker, CI/CD, Nginx) настроена вручную. https://sa1to21.space
